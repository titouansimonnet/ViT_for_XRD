...
fichier = open('label_melange_train.csv',mode='w')
...
for i in range(700):
    ...
    fichier.write('Melange'+str(i+1)+'.txt'+',') #Nom du fichier dans le label
    ...
    melange(composant[0],composant[1],numero=i+1,a_max=399,b_max=399,Percent=True,percent_a=percent_a,percent_b=percent_b) #Création du fichier
    fichier.write('\n')
